...
const AddUserForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#e9dbcf] px-4 py-10 relative" id="add-user">
      {/* Background Glow */}
      ...
      <div className="w-full max-w-md bg-white bg-opacity-70 backdrop-blur-md p-8 rounded-2xl shadow-2xl z-10">
        <h1 className="text-4xl font-bold leading-tight text-gray-900 mb-2">
          Add User <br />
          <span className="text-yellow-600">Details</span>
        </h1>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 rounded-md shadow-md transition-all"
          >
            ADD USER
          </button>
        </form>
