...
const AddVehicleForm = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e4d6c8] px-6 py-8 relative text-center" id="add-vehicle">
      <button className="absolute top-4 left-4 text-3xl">&larr;</button>

      <h1 className="text-4xl font-bold bg-gradient-to-br from-yellow-300 via-yellow-100 to-transparent inline-block p-6 rounded-full mb-6">
        Add Vehicle<br />Name
      </h1>

      {/* Image upload */}
      <div className="my-6">
        <label htmlFor="vehicleImage" className="relative w-28 h-28 rounded-full border-4 border-black mx-auto flex flex-col items-center justify-center cursor-pointer overflow-hidden">
          {vehicleImage ? (
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4">
        <div className="w-full max-w-md">
          ...
          <input
            ...
            required
            className="w-full border-2 border-black p-2 text-lg outline-none"
          />
        </div>

        <button
          type="submit"
          className="mt-4 bg-black text-white px-6 py-3 text-lg uppercase font-bold tracking-wide w-full max-w-md"
        >
