...
const VehiclePricingForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-gradient-to-tr from-yellow-100 to-neutral-100 rounded-xl shadow-md">
      <h1 className="text-3xl font-bold text-gray-800 mb-0">Add vehicle</h1>
      <h2 className="text-2xl font-bold text-gray-700 mb-6">Pricing</h2>
